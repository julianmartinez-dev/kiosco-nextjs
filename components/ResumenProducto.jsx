  ...
  return (
    <div className="shadow p-5 mb-3 md:flex gap-10 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-500 flex gap-2 hover:bg-sky-700 text-white font-bold py-2 px-4 rounded w-full mt-5"
        ...
        <button
          type="button"
          className="bg-red-500 flex gap-2 hover:bg-red-700 text-white font-bold py-2 px-4 rounded w-full mt-5"
